...
//                Text(userProfileVM.profile.name.isEmpty ? "Athlete" : userProfileVM.profile.name)
...
//            StatCard(title: "Workouts", value: "\(workoutVM.totalWorkoutsCompleted)", icon: "figure.strengthtraining.traditional", color: .blue)
//            StatCard(title: "Minutes", value: "\(workoutVM.totalMinutesTrained)", icon: "clock.fill", color: .orange)
//            StatCard(title: "Calories", value: "\(workoutVM.totalCaloriesBurned)", icon: "flame.fill", color: .red)
//        }
//    }
//
...
//                            Text("Rest Day")
//                                .font(.title3).bold()
//                            Text("Recovery is key to progress")
//                                .font(.subheadline)
//                                .foregroundColor(.secondary)
//                        }
//                    }
...
//                    .cornerRadius(16)
//                } else {
//                    NavigationLink(destination: WorkoutDayDetailView(day: day, planName: plan.name).environmentObject(workoutVM)) {
//                        HStack {
...
//                .font(.headline)
//            Text("Choose a workout plan to get started")
//                .font(.subheadline)
//                .foregroundColor(.secondary)
...
//                    Text("\(Int(dietVM.calorieProgress * 100))%")
//                        .font(.caption).bold()
//                }
//            }
//        }
...
//            VStack(alignment: .leading) {
//                Text("\(workoutVM.weeklyStreak) Week Streak")
//                    .font(.title3).bold()
...
//                        WorkoutDayDetailView(day: day, planName: plan.name)
